...
builder.Services.AddScoped<IEmpathyResponseService, EmpathyResponseService>();
builder.Services.AddSingleton<MLContext>();
builder.Services.AddSingleton<IIntentPredictionService, IntentPredictionService>();
builder.Services.AddSingleton<IEmployeeSubIntentPredictionService, EmployeeSubIntentPredictionService>();
builder.Services.AddSingleton<IHrSubIntentPredictionService, HrSubIntentPredictionService>();
builder.Services.AddScoped<IDynamicTrainingService, DynamicTrainingService>();
